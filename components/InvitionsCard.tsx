            ...
            component={
              <View className="flex-1 flex-row justify-between items-center">
                ...
                <View className="flex-1 pr-2">
                  <Text className="text-ms font-Popping-SemiBold text-gray-800">{`${user.first_name || ""} ${user.last_name || ""}`}</Text>
                  <Text className="text-sm font-Popping text-gray-600">{`${((user.similarity_score || 0) * 100).toFixed(0)}% Match`}</Text>
                  <View>
